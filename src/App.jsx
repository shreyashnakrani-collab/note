...
const App = () => {
  ...
  return (
    ...
    {/* div for show all task */}
     <div className='lg:w-1/2 w-full h-screen lg:border-l-2 border-dashed border-black max-lg:border-t-4 bg-gray-200 flex flex-wrap items-center justify-center p-6 gap-6'>
     
    {Tasks.map((task, id) => {
      return (
         <div className='w-full max-w-78 h-78 bg-white rounded-4xl shadow-2xl flex items-end justify-center p-3 relative' key={id}>
         <img src="./1.jpg" alt="" className='w-15 h-10 absolute z-10 top-2'/>
